...
const AppRoutes = () => (
  ...
  <Routes>
    ...
    <Route path="/abastecimento/new" element={<ProtectedRoute><PermissionGuard moduleCode="abastecimento" fallbackAuthenticated><FleetNewPage requestType="abastecimento" /></PermissionGuard></ProtectedRoute>} />
