...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."admission_requests";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."approval_request_steps";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."candidate_documents";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."fuel_requests";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."medical_exams";
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."status_history";



ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."user_role_assignments";
