...
BEGIN
  ...
  -- HARD LOCK: aprovar/devolver/recusar SEMPRE pelo motor de aprovação.
  -- Mesmo Diretoria/Administrativo não podem bypassar o fluxo de aprovação.
