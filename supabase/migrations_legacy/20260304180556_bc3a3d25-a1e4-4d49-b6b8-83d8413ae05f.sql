...
-- 1. Add 'arquivado' to admission_status enum
ALTER TYPE public.admission_status ADD VALUE IF NOT EXISTS 'arquivado';

-- 2. Recreate admission_set_status with the new strict flow
...
BEGIN
  ...
  IF _to_status = 'arquivado' THEN
    -- Only administrativo and diretoria can archive
  ...
  -- Notify RH users for relevant transitions
